...
contract('DappToken', function(accounts){
	...
	it('allocates the initial supply upon deployment', function() {
		return DappToken.deployed().then(function(instance){
			...
			assert.equal(adminBalance.toNumber(), 1000000, 'it allocates the initial totalSupply to the admin account');
		});
	});
	...
	it('handles delegated token transfer', function(){
		return DappToken.deployed().then(function(instance){
			...
			//Try transferring larger than approved amt
			...
			assert.equal(balance.toNumber(), 10, 'adds the amount into the receiving account');
